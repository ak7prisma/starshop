...
import { 
  ...
  CreditCard, ArrowRight, MoreHorizontal, Gamepad2, 
  Trophy, Lock, Loader2, AlertCircle
} from "lucide-react";
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row justify-between md:items-end gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1">Real-time data from Supabase Database.</p>
        </div>
        <div>
            <button className="bg-blue-600 hover:bg-blue-500 text-white px-5 py-2.5 rounded-xl text-sm font-medium transition-all shadow-lg shadow-blue-600/20">
                Download Report
            </button>
        </div>
      </div>
